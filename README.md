...
## ইন্টারফেস ও টাইপ এর মধ্যে পার্থক্য:

1. ইন্টারফেস শুধুমাত্র অবজেক্ট বা ক্লাসের শেপ তৈরী করতে ব্যবহার হয়। আর টাইপ অবজেক্ট ছাড়াও ইউনিয়ন, ইন্টারসেকশান, প্রিমিটিভ এ্যালাইস ইত্যাদি সবকিছুতেই ব্যবহার করা যায়।
2. ইন্টারফেস একাধিকবার ডিক্লিয়ার করা যায়, টাইপ দ্বিতীয়বার ডিক্লিয়ার করা যায় না।
3.ইন্টারফেস খুব সহজে অন্য ইন্টারফেসকে এক্সটেন্ট করতে পারে। টাইপ এ & দিয়ে ইন্টারসেকশান করতে হয়। 

### ইউনিয়ন ও ইন্টারসেকশান এর মধ্যে পার্থক্য:
- ইউনিয়ন এ একটি মান একাধিক টাইপের যেকোন একটি হতে পারে। ইন্টারসেকশান এ একাধিক টাইপকে একত্রিত করে নতুন একটি টাইপ তৈরী করা হয়। 
